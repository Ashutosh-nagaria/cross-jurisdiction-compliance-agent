# California Civil Code Section 1798.82: Breach of security of computerized data
Source: https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CIV&sectionNum=1798.82.
Retrieved: 2026-08-17
Note: this is California's data breach notification statute. It sits in the Civil Code, not the CCPA/CPRA sections (which start at 1798.100), since the user's request flagged that breach notification is not in CCPA itself.
...
Model form fields as they appear in the statute: [NAME OF INSTITUTION / LOGO], Date: [insert date], "NOTICE OF DATA BREACH", followed by the headings "What Happened?", "What Information Was Involved?", "What We Are Doing.", "What You Can Do.", "Other Important Information." with placeholder text "[insert other important information]", and "For More Information." with "Call [telephone number] or go to [internet website]".
